...
type ButtonVariant = "add" | "edit" | "settings";
...
const StyledButton = ({
  ...
  return (
    <button
      className={`border-black border-2 ${bgColors[variant]} ${borderRadius[shape]} ${className}`}
      {...props}
    >
      {icon || children}
    </button>
...
// Pre-configured SVG icons for each variant
