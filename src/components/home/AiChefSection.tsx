...
const AiChefSection = ({ onOpenSuggestDialog }: AiChefSectionProps) => {
  return (
    <section className="mb-10">
      <div className="section-green flex flex-col items-center text-center py-8 rounded-xl relative overflow-hidden">
        ...
        <AiSuggestionButton
          ...
          className="font-black text-lg uppercase border-4 border-black px-6 py-4"
          variant="clean"
        />
      </div>
    </section>
