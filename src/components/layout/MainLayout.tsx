...
const MainLayout: React.FC<MainLayoutProps> = ({
  ...
  // Using a try-catch to handle potential issues with framer-motion
  try {
    return (
      <motion.div
    ...
    // Fallback without animation if there's an issue with framer-motion
    console.error("Error using framer-motion:", error);
    return (
