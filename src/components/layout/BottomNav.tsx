...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-30">
      <div className="flex items-center justify-between bg-gradient-to-r from-primary/95 via-primary to-primary/95 text-primary-foreground rounded-full px-4 py-3 shadow-vibrant relative max-w-[90%] w-fit mx-auto">
        {navItems.slice(0, 2).map((item) => {
          ...
          return (
            <Link
              ...
              to={item.to}
              className={cn(
                "flex flex-col items-center px-4 py-1 transition-all hover:scale-110",
