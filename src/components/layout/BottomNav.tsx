...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-40 w-full px-4">
      <div className="grid grid-cols-5 items-center bg-white border-2 border-black text-black rounded-none py-2 shadow-[5px_5px_0px_0px_rgba(0,0,0,1)] mx-auto max-w-md">
        ...
        <div className="flex justify-center relative">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center justify-center w-12 h-12 rounded-none bg-primary hover:bg-primary/90 transition-all border-2 border-black text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 active:translate-y-0 group">
                <Plus className="w-6 h-6 group-hover:rotate-90 transition-transform duration-300" strokeWidth={3} />
              </button>
            </DropdownMenuTrigger>
            <DropdownMenuContent side="top" align="center" className="w-56 mb-2 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-none animate-in">
              <Link to="/recipes/new">
                <DropdownMenuItem className="cursor-pointer rounded-none group font-bold">
